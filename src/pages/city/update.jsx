...
function Update({ editHandler, editItem }) {
    ...
    const update = useStoreActions(action => action.city.update)
    ...
    useEffect(() => {
        ...
        setStateId(editItem.stateId)
        stateData.forEach(state => {
            if (state.id === editItem.stateId) {
    ...
    const submitHandler = (e) => {
        ...
        update({ id: editItem.id, name, stateId })
    ...
    return (
        <Form onSubmit={submitHandler} className='p-3  mt-3 bg-warning'>
            ...
            <FormGroup>
                <Label className='mb-2 text-dark'><b>Country: </b></Label>
                <Input
                    type='select'
                    value={country}
            ...
            <FormGroup>
                <Label className='mb-2 text-dark'><b>State: </b></Label>
                <Input
                    type='select'
                    value={stateId}
            ...
            <FormGroup >
                <Label className='mb-2 text-dark'><b>City: </b></Label>
                <Input
                    type='text'
                    value={name}
