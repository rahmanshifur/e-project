...
function Create({ editHandler }) {
    ...
    const create = useStoreActions(action => action.product.create)
    ...
    return (
        <Form onSubmit={submitHandler} className='p-3  mt-3 bg-success'>
            <Row>
                <Col sm={6}>
            ...
            <Row>
                <Col sm={6}>
                    <FormGroup className=' py-1 text-light'>
                        <Input
                            type="file"
                ...
                <Col sm={6}>
                    <FormGroup className='py-1 text-light '>
                        ...
                        />
                        {files && files.length !== 0 && files.map(item => <img src={item} alt="Pdt-sub-Img" key={item} height='50' width='50' />)}
